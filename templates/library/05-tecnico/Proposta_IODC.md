...
{% elif pillar.id == 4 %}
A infraestrutura de servidores e processamento é o motor de processamento da solução. Concentra os hosts físicos em um pool de recursos redundante, onde as máquinas e sistemas operam com segurança e performance.
{% elif pillar.id == 5 %}
...
*   **Fase 0 - Entrevista de Expectativa:** Alinhamento inicial de requisitos e visão do cliente.
*   **Fase 1 - Planejamento e Aquisição de Materiais:**
    *   Kick-off, Site Survey e finalização do projeto executivo.
...
*   **Fase 3 - Instalação e Configuração de TI (Semanas 5-9):**
    ...
    *   Provisionamento de sistemas e serviços essenciais.
    *   Testes integrados da infraestrutura.
*   **Fase 4 - Encerramento e Transição (Semanas 10-12):**
...
*   **Handover da Infraestrutura Física:** Apresentação dos ativos, organização dos racks e identificação dos pontos.
*   **Trilha de Operação de Infraestrutura de TI:** Visão Geral dos sistemas, servidores e da solução de backup.
*   **Trilha de Operação e Engenharia de Redes:** Gestão da plataforma e troubleshooting.
