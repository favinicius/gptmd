...
- `debug_extract_style.py/` — explain what lives here and when agents should edit it.
- `DEVELOPMENT_RULES.md/` — explain what lives here and when agents should edit it.
- `diagnose_keys.py/` — explain what lives here and when agents should edit it.
- `input/` — explain what lives here and when agents should edit it.
- `output/` — explain what lives here and when agents should edit it.
- `prd.md/` — explain what lives here and when agents should edit it.
- `ref_models_files/` — explain what lives here and when agents should edit it.
